...
while($row = mysqli_fetch_array($result)) {
    if ($row['Durum'] == "D" && $row['ID'] == 1) {
        $dolu = $dolu + 1;
        echo "<div style=\"left: 28%; top:20%; position: fixed\">
<img src=\"img/car1.png\" width=\"90\" height=\"180\" >
</div>";
    } else if ($row['Durum'] == "D" && $row['ID'] == 2) {
        $dolu = $dolu + 1;
        echo "<div style=\"left: 52%; top:20%; position: fixed\">
    <img src=\"img/car2.png\" width=\"90\" height=\"180\" >
</div>";
    } else if ($row['Durum'] == "D" && $row['ID'] == 3) {
        $dolu = $dolu + 1;
        echo "<div style=\"left: 76%; top:20%; position: fixed\">
    <img src=\"img/car3.png\" width=\"90\" height=\"180\" >
</div>";
    } else if ($row['Durum'] == "D" && $row['ID'] == 4) {
        $dolu = $dolu + 1;
        echo "<div style=\"left: 66%; top:20%; position: fixed\">
    <img src=\"img/car4.png\" width=\"90\" height=\"180\" >
</div>";
    } else if ($row['Durum'] == "D" && $row['ID'] == 5) {
        $dolu = $dolu + 1;
        echo "<div style=\"left: 28%; top:55%; position: fixed\">
    <img src=\"img/car3.png\" width=\"90\" height=\"180\" >
</div>";
